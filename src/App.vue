<template>
      ...
      <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div class="flex lg:flex-1">
          <a href="#" class="-m-1.5 p-1.5">
            <span class="sr-only">CodeFlows</span>
  ...
  <!-- Footer -->
  <footer aria-labelledby="footer-heading" class="relative mt-32">
...
const features = [
  {
    ...
    description:
      'Architecting solutions using the standard and battle tested architectural patterns, best practices, and latest trends in the industry.',
    icon: CloudArrowUpIcon
  },
  {
    name: 'Software Development',
    description:
      'Development is at the foundation of the vision. We have practical experiences on various programming languages and technologies.',
    icon: LockClosedIcon
  },
  {
    name: 'Business Analysis',
    description:
      'Any vision aims to fullfill certain needs and support certain use cases. The conceptual model is at the core of the business domain.',
    icon: ArrowPathIcon
  },
  {
    name: 'Advanced security',
    description: 'Secure development and standard security practices are included by default.',
